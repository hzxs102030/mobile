<template>
	<div>
		<div style="width:100%;height: 600px;background-color: white;position: absolute;box-shadow: 0 2px 4px rgba(0, 0, 0, .12), 0 0 6px rgba(0, 0, 0, .04)">
			<el-steps :active="2" style="width:90%;position: absolute;left: 0%;top:5%;left: 5%;">
			  <el-step   icon="el-icon-goods"></el-step>
			  <el-step  icon="el-icon-s-goods"></el-step>
			  <el-step   icon="el-icon-s-claim"></el-step>
			...
			<div style="width:265px;position:fixed;right: 0%;bottom: 0;height: 41px;">
				<el-button-group>
				  <el-button type="primary" icon="el-icon-bottom-left" style="background-color:green;width: 110px;border: 1px solid #00B7FF;" @click="dialogVisible = true">微信支付</el-button>
				  <el-button type="primary" style="width: 110px;border: 1px solid green;" @click="dialogVisible = true">支付宝<i class="el-icon-bottom-right"></i></el-button>
				</el-button-group>
			</div>
		</div>
		<el-dialog
