...
<div style="width:100%;height: 100%;position:absolute;right:0%;">
		...
		<div style="position: absolute;width:100%;height: 80%;top: 20%;background-image:url(https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2526330978,2775141959&fm=26&gp=0.jpg); background-repeat:no-repeat;background-size:100% auto;" >
		</div>	
		<div style="position: absolute;width:100%;height:100%; box-shadow: 0 2px 4px rgba(0, 0, 0, .12), 0 0 6px rgba(0, 0, 0, .04);color: white;" >
			
			<el-tabs v-model="activeName" @tab-click="handleClick" stretch id="ccc">
			    <el-tab-pane label="用户登录" name="first" style="color: white;" >
					
				<el-form :model="numberValidateForm" ref="numberValidateForm" label-width="30%"  class="demo-ruleForm" ><br>
						  <el-form-item
						  ...
						  >  
						 <el-input type="username" v-model.number="numberValidateForm.username" autocomplete="off" style="width:68%" ></el-input>
						  </el-form-item>
						  <el-form-item
						    label="密码"
						    prop="password"
						  ...
						  >
						    <el-input type="password" v-model.number="numberValidateForm.password" autocomplete="off" style="width:68%;background-color:rgba(255,255,255,0.8);"></el-input>
					
						<el-link type="primary" @click="xiugai = true"  style="margin-left: 1px;position: absolute;right: 5%;color: coral;" :underline="false">忘记密码</el-link>
						  </el-form-item>
						  
						  <el-form-item>
							        <el-button  type="primary" @click="kiki" style="width:68%;background-color:rgba(255,255,255,0);color: #000000;border: 1px rgba(255,255,255,0) solid;box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.9) ;">登录</el-button>
							
						  </el-form-item>
						  
						  <el-dialog  :visible.sync="xiugai" custom-class="mima" >
						    <p style="text-align: center;color:#000000;font-size: 18px;border-bottom: 2px solid white;">账户密码找回</p>
									<br><br>
						      <el-form-item
						        label="手机号"
						        prop="phone"
						      ...
						      >
						        <el-input type="phone" v-model.number="numberValidateForm.phone" autocomplete="off" style="width:78%"></el-input>
						      </el-form-item>
						      ...
						      >
						        <el-input type="code" v-model.number="numberValidateForm.code" autocomplete="off" style="width:35%"></el-input>
						      ...
						      >
						        <el-input type="password" v-model.number="numberValidateForm.password" autocomplete="off" style="width:78%"></el-input>
						    </el-form-item><el-form-item>
						    	<el-button  type="primary" @click="change" style="width: 78%;">修改后登录</el-button>
				...
				<el-form :model="numberValidateForm" ref="numberValidateForm" label-width="30%" class="demo-ruleForm" >
				  ...
				  >
				    <el-input type="username" v-model.number="numberValidateForm.username" autocomplete="off" style="width:78%"></el-input>
				  </el-form-item>
				    ...
				    >
				      <el-input type="code" v-model.number="numberValidateForm.code" autocomplete="off" style="width:35%;background-color:rgba(255,255,255,0.8);"></el-input>
					  <el-button @click="getcode2" :disabled="disabled" v-model="time" style="background-color:rgba(255,255,255,0.4);color: coral;border: 1px orange solid;">{{time}}</el-button>
				    </el-form-item>
				  ...
				  >
				    <el-input type="password" v-model.number="numberValidateForm.password" autocomplete="off" style="width:78%;background-color:rgba(255,255,255,0.8);"></el-input>
				  </el-form-item>
				  <el-form-item>
					  
				    <el-button type="primary" @click="kiki2" :plain="true" style="background-color:rgba(255,255,255,0.4);color: #000000;width:78%;border: 1px rgba(255,255,255,0) solid;box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.9) ;">注册</el-button>
				  </el-form-item>
				</el-form>	
...
.mima{width: 100%;background-color:rgba(255,255,255,0.85);;position: absolute;}
</style>
<script>
 export default {
    data() {
