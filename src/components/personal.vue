<template>
	<div style="display: flex;height: 100;" v-show="show1" >
	      <transition name="el-fade-in-linear"  >
	        <div class="transition-box" style="height: 200px;width: 96%;margin-right: 2%;margin-left: 2%;">
			...
			<div style="position: absolute;right: 5%;top: 170px;">
				<el-button plain size="mini" style="box-shadow: 0 2px 12px 0 rgba(0, 255, 0, 0.8);color: green;" @click="pd">修改密码</el-button>	
			</div>
			<div style="position: absolute;right: 5%;top: 210px;">
				<el-button plain size="mini" style="box-shadow: 0 2px 12px 0 rgba(255, 0, 0, 0.8);color:firebrick;" @click="exit">注销账户</el-button>	
			</div>
			</div>
	      </transition>
