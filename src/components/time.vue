...
<div style="position: absolute;right: 5px;">			
				  <el-button type="primary" icon="el-icon-date" style="background-color: #EDEDED;color: #000000;border: deeppink 1px solid;font-size: 12px;" @click="gettime" size="small">择日入住</el-button>
			 <el-dialog title="订单详情" :visible.sync="uptime" custom-class="shijian">
				 <div style="100%;height:400px;">
		
		<div>
			<el-collapse v-model="activeNames" @change="handleChange" style="height: 400px;overflow-x: hidden; overflow-y: auto;font-size: 15px;">
