<template>
	<div style="display: flex;height: 100px;z-index: 10;" v-show="show5" >
	      <transition name="el-fade-in-linear" >
	        <div class="transition-box"style="position: absolute;top:50px;width:100%;height: 700px;overflow-x: hidden; overflow-y: auto;
			padding-left: 0px;padding-right: 0px;">
			<div style="font-size: 24px;width: 100%;border-bottom: 1px solid rgba(0,255,255);">管理联系地址
			...
			<el-link type="primary" style="position: absolute;right: 30px;color: rgba(0,255,255);top:50px" :underline="false"><i class="el-icon-circle-plus-outline" @click="show=!show">添加新地址</i></el-link>
				...
				size="mini"
			  	:header-cell-style="tableHeaderColor" style="margin-top: 20px;">
			  				<el-table-column property="name" label="联系人" width="59"></el-table-column>
							<el-table-column property="phone" label="联系电话" width="100"></el-table-column>
			  			    <el-table-column property="address" label="联系地址" width="150"></el-table-column>
			  				<el-table-column width="180"   label="地址操作">
