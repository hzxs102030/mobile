<template>
	<div style="display: flex;height: 100px;">
	      <transition name="el-fade-in-linear" >
	        <div class="transition-box" v-show="show4" style="position: absolute;width: 100%;height: 700px;overflow-x: hidden; overflow-y: auto;
			padding-left: 0px;padding-right: 0px;top:50px">
			<div style="font-size: 24px;width:100%;border-bottom: 1px solid rgba(0,255,255);">预订订单
