<template>
	<div style="display: flex;height: 100px;" v-show="show">
	      <transition name="el-fade-in-linear" style="">
	        <div class="transition-box" style="position: absolute;top:10%;position: absolute;height: 420px;width:100%;background-color: rgba(0,0,0,0.9);z-index: 20;">
			<el-form :model="receive" :rules="rules" ref="receive" label-width="100px" class="demo-ruleForm" >
			  <el-form-item  class="hhh" label="联系人姓名" prop="name" >
			    <el-input v-model="receive.name" @blur="inspectName" @focus="clickName"></el-input>
			  </el-form-item>
			  <el-form-item  class="hhh"label="联系人电话" prop="phone">
			  ...
			  <el-form-item  class="hhh"label="联系地址" prop="address">
