<template>
	<div style="display: flex;height: 100px;">
	      <transition name="el-fade-in-linear" >
	        <div class="transition-box" v-show="show3" style="position: absolute;top:50px;width:100%;height: 700px;overflow-x: hidden; overflow-y: auto;
			padding-left: 0px;padding-right: 0px;">
			<div style="font-size: 24px;width:95%;border-bottom: 1px solid rgba(0,255,255);padding-left: 5%;">预订订单
