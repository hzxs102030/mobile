...
<div>
	...
	<el-dialog
	  ...
	  custom-class="dw"
	  >
		<div style="width: 100%;height:350px;":before-close="handleClose">
					  
					  <div slot="reference" style="background-color:white;color:#000000;width:90%;height: 30px;padding-top: 15px;padding-bottom: 10px;
				  						position:absolute;left: 0%;top:5px; text-align: center">当前地址:<i class="el-icon-location-information"></i>{{address}}</div>
					...
					<div style="height:100%;padding-top: 10px;
						...
						<el-input style="width: 68%;" v-model="search_val" placeholder="请输入小区/写字楼/学校等" id="search"></el-input>
						<div style="width:100%;height:330px;overflow-x: hidden; overflow-y: auto;">
	...
	<el-dialog
	  ...
	  <div style="width: 100%;height: 350px;background-color: write;">
	  			     			  
	  			     			  <div slot="reference" style="background-color:white;color:#000000;width:90%;height: 30px;padding-top: 20px;padding-bottom: 10px;left: 0%;
	  							...
	  							<transition name = "fade">
	  							  <div style="width:100%;height:280px;overflow-x: hidden; overflow-y: auto;border-bottom:1px solid #DCDFE6 ;" v-if="chanceProvince"> 
	  ...
	  " style="">
	  							...
	  							<transition name = "fade">
	  							  <div style="width:100%;height:280px;overflow-x: hidden; overflow-y: auto;border-bottom:1px solid #DCDFE6 ;" v-if="chanceCity"> 
